...
@dataclass
class DiffusionGemmaAttnMetaData(MultiBlockAttnMetaDataMixin):
    def __post_init__(self):
        self.init_multi_block()


DIFFUSION_GEMMA_ATTN_METADATA = DiffusionGemmaAttnMetaData()


def fetch_diffusion_gemma_attn_metadata() -> DiffusionGemmaAttnMetaData:
    return DIFFUSION_GEMMA_ATTN_METADATA


def set_diffusion_gemma_attn_metadata(
    ...
    global DIFFUSION_GEMMA_ATTN_METADATA
...
def reset_diffusion_gemma_attn_metadata() -> None:
    global DIFFUSION_GEMMA_ATTN_METADATA
    DIFFUSION_GEMMA_ATTN_METADATA = DiffusionGemmaAttnMetaData()
